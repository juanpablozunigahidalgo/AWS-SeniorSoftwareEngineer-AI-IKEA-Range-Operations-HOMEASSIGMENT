...
const swaggerOptions = {
  definition: {
    ...
    servers: [
      {
        url: "/", // <--- CRÍTICO PARA AWS: Usa la ruta relativa del servidor actual
        description: "Servidor Actual (AWS/Local)"
      },
      {
    ...
    // Definición manual de rutas para evitar problemas de importación en el build
    paths: {
      "/products": {
        get: {
